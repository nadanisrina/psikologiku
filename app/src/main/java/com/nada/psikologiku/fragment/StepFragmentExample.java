...
//                        Toast.makeText(getContext(), text, Toast.LENGTH_SHORT).show();
        ...
        final List<Quiz> lk = mDBHelper.getQuestionByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
        final List<Quiz> op1 = mDBHelper.getOption1ByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
        final List<Quiz> op2 = mDBHelper.getOption2ByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
        final List<Quiz> op3 = mDBHelper.getOption3ByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
        final List<Quiz> op4 = mDBHelper.getOption4ByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
        final List<Quiz> op5 = mDBHelper.getOption5ByGroup(String.valueOf(Integer.valueOf(bundle.getInt(MyStepperAdapter.CURRENT_STEP_POSITION_KEY)) + 1));
